...
import { useScreenTracking, usePlanAnalytics } from './lib/analytics/analytics.hooks';
...
export default function History() {
  ...
  const handleViewPlan = (plan: Plan) => {
    ...
    // This would navigate to a plan detail view
    // router.push({
    //   pathname: '/plan-detail',
    //   params: { id: plan.id }
    // } as any);
    
    // For now, just show an alert since we haven't implemented the detail view
    Alert.alert(
      'View Plan',
      'Plan detail view will be implemented in the next sprint.',
      [{ text: 'OK' }]
    );
  };
